          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-up">
              ...
              <p className="text-lg mb-6 leading-relaxed">
                Меня зовут Александр, и я создаю свадебные фильмы уже более 8 лет. 
                Моя страсть — storytelling и кинематографичный подход к каждой съемке.
              </p>
              <p className="text-lg mb-6 leading-relaxed">
            ...
            <div className="animate-scale-in">
              <div className="relative">
                <img 
                  src="https://cdn.poehali.dev/files/b77407c5-3845-4642-9816-94afdce4af09.jpg" 
